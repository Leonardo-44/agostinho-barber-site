...
export const criarAgendamentoFixo = async (payload, token) => {
  return apiCall("/agendamentos/criar", {
    method: "POST",
    body: JSON.stringify(payload),
    headers: { Authorization: `Bearer ${token}` },
...
// Deleta o agendamento do fixo do banco (usado ao voltar para pendente)
export const deletarAgendamentoFixo = async (agendamentoId, token) => {
  return apiCall(`/agendamentos/${agendamentoId}/cancelar`, {
    method: "DELETE",
    headers: { Authorization: `Bearer ${token}` },
  });
...
export const fetchClientesFixos = async (token) => {
  return apiCall("/clientes-fixos", {
    method: "GET",
    headers: { Authorization: `Bearer ${token}` },
  });
};

export const criarClienteFixo = async (payload, token) => {
  return apiCall("/clientes-fixos", {
    method: "POST",
    body: JSON.stringify(payload),
    headers: { Authorization: `Bearer ${token}` },
...
export const atualizarClienteFixo = async (id, payload, token) => {
  return apiCall(`/clientes-fixos/${id}`, {
    method: "PUT",
    body: JSON.stringify(payload),
    headers: { Authorization: `Bearer ${token}` },
  });
...
export const deletarClienteFixo = async (id, token) => {
  return apiCall(`/clientes-fixos/${id}`, {
    method: "DELETE",
    headers: { Authorization: `Bearer ${token}` },
  });
...
export const fetchHorariosBloqueadosFixos = async (data) => {
  return apiCall(`/clientes-fixos/bloqueados?data=${data}`, { method: "GET" });
};
...
const api = {
  ...
  removerDiaExcecao,
  // Clientes Fixos
  criarAgendamentoFixo,
  deletarAgendamentoFixo,
  fetchClientesFixos,
  criarClienteFixo,
  atualizarClienteFixo,
  deletarClienteFixo,
  fetchHorariosBloqueadosFixos,
};
